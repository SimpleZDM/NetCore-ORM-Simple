    ...
    public class SimpleSqliteTest
    {
        ...
        public void QueryTest()
        {
            try
            {
                ...
                List<UserEntity> user1 = client.Queryable<UserEntity>().Where(u => u.Id.Equals(dic[1816]) && u.Id.Equals(ids[0]) || Simple.IsNullOrEmpty(u.Name) || lids[1].Equals(u.Id)).ToList();
