    ...
    public class SimpleMysqlTest
    {
        ...
        public void QueryTest()
        {
            ...
            try
            {
               ...
               //// var data11111 = JoinData1.ToList();
               //// ///连接查询分组
               ...
               ////   {
               ////       Count = v.Count(),
               ////       UserName = v.FirstOrDefault(s => s.UserName),
               ////       RoleId= v.Max(s => s.RoleId)
               ////   }).ToList();
        ...
        public void JoinTest()
        {
            for (int i = 0; i < 100; i++)
            {
             ...
             LeftJoin<RoleEntity>((u, r, r2, r3, r4, r5) => u.RoleId == r5.Id).
             LeftJoin<RoleEntity>((u, r, r2, r3, r4, r5, r6) => u.RoleId == r6.Id).
             LeftJoin<RoleEntity>((u, r, r2, r3, r4, r5, r6, r7) => u.RoleId == r7.Id).Take(100).ToList();

                //var data6 = client.Queryable<UserEntity>().Take(100).ToList();
                //   var data5 = client.Queryable<UserEntity>().
                //LeftJoin<RoleEntity>((u, r) => u.RoleId == r.Id).Take(100).ToList();

                //var data5 = client.Queryable<UserEntity>().
                //LeftJoin<RoleEntity>((u, r) => u.RoleId == r.Id).
                //LeftJoin<RoleEntity>((u, r, r2) => u.RoleId == r2.Id).Take(2000).ToList();
            }
